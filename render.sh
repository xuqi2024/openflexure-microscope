...
openscad --hardwarnings -o "docs/renders/actuator_parts.png" -D "FRAME=1;" --camera=2,5,14,33,0,242,360 --imgsize=2400,2000  rendering/actuator_assembly_parts.scad
openscad --hardwarnings -o "docs/renders/actuator_parts.png" -D "FRAME=2;" --camera=26,22,44,69,0,97,290 --imgsize=2400,2000  rendering/actuator_assembly_nut.scad
openscad --hardwarnings -o "docs/renders/actuator_parts.png" -D "FRAME=3;" --camera=26,22,44,79,0,173,290 --imgsize=2400,2000  rendering/actuator_assembly_gear.scad
openscad --hardwarnings -o "docs/renders/actuator_parts.png" -D "FRAME=4;" --camera=26,22,44,79,0,173,290 --imgsize=2400,2000  rendering/actuator_assembly_gear2.scad
