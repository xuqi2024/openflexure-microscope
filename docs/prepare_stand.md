...
* Take [microscope stand][Microscope stand](fromstep){qty:1, cat:printedpart}
* Place an [M3 nut]{qty:4} in the slot under a mounting lug
* Put an [M3x8 cap head screw][extra M3x8 cap screw](parts/fixings/m3x8mm_caphead_screw.md){qty: 1, cat:tool} into the hole above the nut
