...
* [Upright condenser]{output,qty:1}: [upright_condenser.stl](models/upright_condenser.stl){previewpage} - **This should be printed in a dark, opaque filament.** The condenser may require [custom print settings] as used for the smart brim.
