...
* Place the upside-down seperate z-actuator with the optics module now attached onto the z-actuator mount. 
* While holding these together, place 4 [M3x10 cap head screws](parts/mechanical.yml#CapScrew_M3x10mm_SS){qty: 4, cat:mech}  into the 4 bored holes in the seperate z-actuator and screw tightly into place. 
