...
**Warning:** you must use a resistor in series with the LED to avoid drawing too much current, as described in the illumination instructions.  This may damage your Raspberry Pi if done incorrectly.
