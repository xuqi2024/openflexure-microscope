...
* Take the [electronics drawer](fromstep){qty:1, cat:printedpart} you printed earlier and push the [Raspberry Pi]{qty:1} into place so the connectors show through the holes.
