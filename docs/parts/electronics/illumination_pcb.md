...
An alternative version of the illumination PCB for use with the [Sangaboard v0.5]'s
brightness control feature, can be purchased as part of the illumination kit at [taulab.eu].
