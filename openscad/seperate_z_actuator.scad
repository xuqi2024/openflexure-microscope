...
seperate_z_actuator_with_smart_brim(params = default_params());

module seperate_z_actuator_with_smart_brim(params){
    $fn=32;
    ...
    exterior_brim(r=smart_brim_r){
        seperate_z_actuator(params, cable_guides = false, cable_housing = false, rectangular = true);
    }
}
