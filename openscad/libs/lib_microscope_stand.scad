...
function default_stand_params(tall=false, no_pi=false, pi_version=4, sanga_version="HAT_8.5mm") =
    assert(pi_version==3 || pi_version==4, "pi_version must be 3 or 4")
    assert(sanga_version=="v0.3" || sanga_version=="HAT_8.5mm" || sanga_version=="HAT_11mm", "sanga_version must be \"v0.3\", \"HAT_8.5mm\" or \"0.5\"")
...
function sanga_stand_height(sanga_version="HAT_8.5mm") = let(
    extra_h = (sanga_version=="HAT_8.5mm") ?
                12.5 :
...
function electronics_drawer_mount_block_size() = let(
    height = sanga_stand_height("HAT_11mm"),
...
function sanga_connector_x(sanga_version) = (sanga_version=="HAT_8.5mm" || sanga_version=="HAT_11mm") ?
                                                11.2 :
                                                23.7;
...
module sanga_connector_holes(sanga_version){
    ...
    board_inset = (sanga_version=="HAT_8.5mm" || sanga_version=="HAT_11mm") ?
        electronics_drawer_board_inset() :
        electronics_drawer_board_inset() + [v0_3_offset_x, 0, 0];

    wall_t = electronics_drawer_wall_t();
    connector_extra_z = (sanga_version=="HAT_8.5mm" || sanga_version=="HAT_11mm") ?
                            3 :
                            3.75;
