...
def register_rendered_separate_z_actuator_stl(rendersystem, force_clean):
...
def main():
    ...
    register_rendered_separate_z_actuator_stl(rendersystem, force_clean=args.force_clean)
